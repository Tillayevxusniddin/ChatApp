  ...
  return !verify ? (
      ...
      <FormField
        ...
        render={( { field } ) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder='Oman' className='bg-secondary' disabled {...field}/>
            </FormControl>
      ...
      <FormField
        ...
        render={( { field } ) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder='tillayevx1@gmail.com' className='h-10 bg-secondary' disabled={otpMutation.isPending} {...field}/>
            </FormControl>
            <FormMessage className='text-xs text-red-500'/>
          </FormItem>
        )}
    ...
    <Form {...otpForm}>
      <form onSubmit={otpForm.handleSubmit(onVerifySubmit)} className='space-y-2'>
        ...
        <Input className='h-10 bg-secondary' disabled value={emailForm.watch('email')}></Input>
        <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <InputOTP maxLength={6} className="w-full" pattern={REGEXP_ONLY_DIGITS} disabled={verifyMutation.isPending} {...field}>
